  ...
  class TestSOAP < Test::Unit::TestCase
    ...
    def test_SOAPDateTime
      ...
      targets = [
                 ...
                 ["2002-12-31T23:59:59+09:00","2002-12-31T14:59:59.000000Z"],
                 ["2002-12-31T23:59:59+00:01","2002-12-31T23:58:59.000000Z"],
                 ["2002-12-31T23:59:59-00:01","2003-01-01T00:00:59.000000Z"],
                 ["2002-12-31T23:59:59-23:59","2003-01-01T23:58:59.000000Z"],
                 ["2002-12-31T23:59:59.00000000000000000001+13:30","2002-12-31T10:29:59.000000Z"],
                 ["2002-12-31T23:59:59.51375Z","2002-12-31T23:59:59.513750Z"],
                 ["2002-12-31T23:59:59.51345+12:34","2002-12-31T11:25:59.513450Z"],
                 # ["-2002-05-18T16:52:20Z","-2002-05-18T16:52:20.000000Z"],
                 # ["-4711-12-31T23:59:59Z","-4711-12-31T23:59:59.000000Z"],
                 # ["-4713-01-01T12:00:00Z","-4713-01-01T12:00:00.000000Z"],
                 # ["-19999-12-31T23:59:59Z","-19999-12-31T23:59:59.000000Z"],
                 # ["-2002-12-31T23:59:59+00:01","-2002-12-31T23:58:59.000000Z"],
                 # ["-0001-12-31T23:59:59.00000000000000000001+13:30","-1-12-31T10:29:59.000000Z"],
    ...
    def test_SOAPDate
      ...
      assert_equal(nil, o.data)
      assert_equal(true, o.is_nil)
      # no supported anymore, cause these formats are stupid
      #      targets = [
      #                 "2002-05-18Z",
      #                 "0001-01-01Z",
      #                 "9999-12-31Z",
      ...
      targets = [
                 ...
                 ["2002-12-31+00:00","2002-12-31"],
                 ["2002-12-31-00:00","2002-12-31"]
# more negative dates - why ?????
#                 ["-2002-12-31","-2002-12-31"],
#                 ["-2002-12-31+00:00","-2002-12-31Z"],
#                 ["-2002-12-31-00:00","-2002-12-31Z"],
                ]
      targets.each do |data, expected|
